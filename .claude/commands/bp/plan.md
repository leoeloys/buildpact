---
description: "Create a parallel execution plan from a spec — researches tech stack and codebase, generates dependency-sorted waves, validates completeness, and produces ADRs for architectural decisions."
---
