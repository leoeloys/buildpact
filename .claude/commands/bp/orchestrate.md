---
description: "Master orchestrator — scans project state, detects user intent, and routes to the right specialist (Sofia, Renzo, Coda, Crivo, Lira). The default entry point for BuildPact."
---
...
- **Default entry point** — when the user just wants to "use BuildPact" without a specific command
- **Multi-phase work** — orchestrates handoffs between specify → plan → execute → verify
- **Intent detection** — user describes what they want, Pacto routes to the right specialist
- **After completing a phase** — Pacto recommends the next step
