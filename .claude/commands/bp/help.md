---
description: "Scan project state and recommend the most useful next step — shows pipeline position, available commands, and active squad status."
---
...
- **"What can I do?"** — shows all available commands with context
- **"What should I do next?"** — analyzes project state and recommends the next action
- **New to BuildPact** — quick orientation on the pipeline and available commands
- **Checking squad status** — see which squad is active and how it routes phases
