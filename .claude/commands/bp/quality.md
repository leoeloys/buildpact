---
description: "ISO 9001-inspired quality audit — inventories artifacts, checks process compliance, calculates quality metrics (first-pass yield, traceability), and reports non-conformances."
---
...
- **Before a release** — audit that all specs have complete pipeline chains
- **After multiple verify runs** — check first-pass yield and process compliance
- **Continuous improvement** — identify recurring failures and process gaps
- **Compliance audit** — demonstrate that constitution rules were respected throughout
