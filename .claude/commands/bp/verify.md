---
description: "Validate implementation against spec acceptance criteria, run mandatory adversarial review, generate fix plans for failures, and capture feedback to the 3-tier memory system."
---
